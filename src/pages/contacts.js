...
const socialLink = [
  ...
  {
    link: "https://youtube.com/thelavanderconsultancy",
  ...
  {
    link: "https://linkedin.com/company/thelavanderconsultancy",
...
const Contacts = () => {
  ...
  const title = "Contact Us | The Lavander Consultancy";
  const description =
    "Get in touch with The Lavander Consultancy to apply to your dream universities. Our expert guidance and support from accomplished alumni and current students can help you get accepted. Contact us for free personalized guidance and counseling..";
  const url = "https://www.thelavanderconsultancy.com/contacts";
  const image = `${process.env.ENDPOINT}/home.jpg`;

  const keywords =
    "The Lavander Consultancy Contact, study abroad, personal guidance, free guidance, free counseling, free courses, apply to universities";
            ...
            <Stack mt="10">
              <Flex alignItems={"center"} gap="2" bg="teal.900">
                ...
                <Text color={"white"} fontSize="14">
                  contact@thelavanderconsultancy.com
                </Text>
              </Flex>
