...
const index = () => {
  const title =
    "The Lavander Consultancy | Rise by Lifting Others! Apply to Dream Universities with Expert Guidance and Support for Free";
  const description =
  ...
  const url = "https://www.thelavanderconsultancy.com";
