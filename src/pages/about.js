...
const about = () => {
  const title = "About Us | The Lavander Consultancy";
  const description =
    "Learn more about The Lavander Consultancy and our mission to help students apply to their dream universities with expert guidance and support from accomplished alumni and current students. Discover our free personalized counseling and courses today.";
  const keywords =
    ...
    <div>
      ...
      <Container py="16" px={[4, 4]} maxW={["100vw", "100vw", "70vw"]}>
        <Heading
          ...
          as={"h2"}
        >
          Introducing The Lavander Consultancy
        </Heading>

        <Stack mt="5" spacing={4} fontWeight="light">
          <Text fontSize="lg">
            Welcome to The Lavander Consultancy! Are you ready to go on a courageous,
          ...
          <Text fontWeight="normal">
            ...
            <br />
            At The Lavander Consultancy, we believe that everyone deserves access to
            ...
            <br />
            At The Lavander Consultancy, we are passionate about helping students realize
